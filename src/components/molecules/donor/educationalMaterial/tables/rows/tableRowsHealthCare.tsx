...
import ArticleHomeHealthCare from "../../articles/articleHomeHealthCare";

const TableRowsHealthCare = () => {
        ...
        <Tabs value="html">
          <TabsBody placeholder={""}>
            {isLoading ? (
              ...
              <>
                {selectedTab === ARTICLES ? (
                  <ArticleHomeHealthCare data={educationMaterialsAriclesData} />
                ) : selectedTab === VIDEOS ? (
...
export default TableRowsHealthCare;
