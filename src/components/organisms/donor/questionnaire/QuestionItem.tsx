...
const QuestionItem = ({
  ...
  useEffect(() => {
    // if (question.inputType === InputType.YESANDNO && question.answer !== null) {
    //   setIsNextButtonVisible(true);
    // }
    if (questionIndex !== undefined && setIsNextButtonVisible) {
      if (
        (!question.isYesSelected && question.noQuestions === null) ||
    ...
    // if (questionIndex && setIsNextButtonVisible) {
    //   if (
    ...
    //   }
    // }
  }, [questionIndex, question.isYesSelected, question.noQuestions]);
