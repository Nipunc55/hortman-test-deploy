...
const SearchBar = ({
  ...
  return (
    <div className="gold-gradient-input-border flex w-70 h-10 relative justify-between items-center">
      <input
      ...
      <IconButton
        placeholder={""}
        onClick={onclick}
        className="z-50 bg-transparent outline-none shadow-none hover:shadow-none"
      >
        <svg
