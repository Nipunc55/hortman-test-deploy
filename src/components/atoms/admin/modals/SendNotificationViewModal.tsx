...
const SendNotificationViewModal = ({
  open,
  handleOpen,
  handleClose,
  data
        ...
        >
          ...
          <div className="text-black-500">
            <div className="px-5 pt-4 pb-[30px] flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2.5">
                <div className="text-xsxl font-medium">Sender:</div>
                <div className="text-base font-normal">
                  {data?.sender?.name}
                </div>
              </div>
              <div className="flex flex-col gap-2.5">
                <div className="text-xsxl font-medium">Template Name:</div>
                <div className="text-base font-normal">{data?.title}</div>
              </div>
              <div className="flex flex-col gap-2.5 ">
                <div className="text-xsxl font-medium">Message:</div>
                <div className="border border-secondary p-2.5 font-normal rounded-[5px] min-h-40">
                  {data?.body}
                </div>
              </div>
            </div>
...
export default SendNotificationViewModal;
